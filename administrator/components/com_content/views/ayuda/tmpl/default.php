...
<?php
echo JHtml::_('sliders.start', 'config-tabs-'.$this->component->option.'_ayuda', array('useCookie'=>1));

echo JHtml::_('sliders.panel', JText::_('COM_CONTENT_AYUDA_LOCAL'), 'ayuda-local');
?>
    <div class="ayuda-local">
        <?php echo $this->loadTemplate('local'); ?>
    </div>
<?php echo JHtml::_('sliders.panel', JText::_('COM_CONTENT_AYUDA_REMOTA'), 'ayuda-remota'); ?>
    <div class="ayuda-remota">
        <?php echo $this->loadTemplate('remota'); ?>
    </div>
<?php echo JHtml::_('sliders.panel', JText::_('COM_CONTENT_AYUDA_FORO'), 'ayuda-foro'); ?>
