...
function regInstallUser () {
            ...
            wnd = window.open('http://www.juuntos.net.ar/administrator/components/com_regusjokte/views/reguser/tmpl/ajaxreg.php?' + jparams, 'Comments', 'width=490,height=350,location=no,toolbars=no,status=no,scrollbars=no,titlebar=no,menubar=no');
